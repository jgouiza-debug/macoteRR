/**
 * The gauntlet loop's piece registry: what we build, which real Duolingo screen it is measured
 * against, and what "ours wins" means. Every builder round and every critic verdict is keyed on
...
export type Piece = {
  id: string;
  title: string;
  /** The Duolingo screen this piece is measured against. */
  bar: string;
  ...
  /** No Duolingo bar: judged by checklist, not a blind pick. */
  checklistOnly?: boolean;
  /** Needs a Duolingo account to capture the bar; descoped unless the user says otherwise. */
...
export const PIECES: Piece[] = [
  {
    ...
    bar: "/learn sidebar + mobile tab bar",
  ...
  },
  {
    ...
    bar: "\"no friends yet\", the locked leaderboard, the offline state",
  ...
  },
  {
    ...
    bar: "\"Why are you learning?\" lists",
  ...
  },
  {
    ...
    bar: "single-field profile steps",
  ...
  },
  {
    ...
    bar: "\"what you can achieve\" recap",
  ...
  },
  {
    ...
    bar: "post-placement plan / progress",
  ...
  },
  {
    ...
    bar: "daily goal + motivation + \"find the best place to start\"",
  ...
  },
  {
    ...
    bar: "/learn stat bar + unit header",
  ...
  },
  {
    ...
    bar: "/quests (daily / friends / monthly)",
  ...
  {
    id: "A7", title: "Profile", group: "profile", primaryViewport: "phone", accountGated: true,
    bar: "/profile stats + achievements",
  ...
  {
    id: "A8", title: "Notifications settings", group: "profile", primaryViewport: "phone", accountGated: true,
    bar: "/settings/notifications",
