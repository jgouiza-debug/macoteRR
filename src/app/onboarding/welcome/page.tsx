...
export default function WelcomePage() {
  ...
  function handleStart() {
    ...
    router.push(firstIncompletePath(readProfile()));
  }

  return (
    <main className="flex min-h-[100dvh] w-full flex-col items-center justify-center bg-chalk px-5 py-10 text-center">
      <style>{`
      ...
      <div className="flex w-full max-w-[360px] flex-col items-center">
        ...
        >
          ...
          <button
            type="button"
            onClick={handleStart}
            className="mt-8 flex h-[52px] w-full items-center justify-center rounded-full bg-ultramarine text-[15px] font-semibold text-paper shadow-card tap-spring active:scale-[0.98] focus-visible:outline-none"
          >
            {t("welcome.cta")}
          </button>
        </div>
