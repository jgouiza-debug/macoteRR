...
export function WhatIfSheet({
  ...
  return (
    <Sheet open={open} onClose={onClose} title={t("dash.whatIf")}>
      ...
      <div className="mt-4 flex items-center gap-2">
        <button
          ...
          className="flex h-12 flex-1 items-center justify-center gap-1.5 rounded-full border border-ink/20 text-[14px] font-semibold text-ink tap-spring"
        >
        ...
        <button
          type="button"
          onClick={onClose}
          className="flex h-12 flex-1 items-center justify-center rounded-full bg-ultramarine text-[14px] font-semibold text-paper tap-spring"
        >
          {t("common.close")}
        </button>
      </div>
