  ...
  return (
    <header className="w-full bg-chalk pt-safe border-b border-ink/5">
      <div className="mx-auto flex h-14 w-full max-w-[1120px] items-center justify-between px-4 md:px-10">
        {/* Brand Logo Lockup */}
        <Link href="/" className="-ml-1 flex min-h-[48px] items-center gap-2 px-1 text-ink hover:opacity-90 transition-opacity">
        ...
        <div className="flex items-center gap-4 text-[13px] font-medium text-secondary">
          <div className="hidden md:flex items-center gap-4">
            <Link href="/mentions-legales" className="inline-flex min-h-[48px] items-center hover:text-ink transition-colors">
              {t("mkt.navMentions")}
            </Link>
            <Link href="/methodologie-sources" className="inline-flex min-h-[48px] items-center hover:text-ink transition-colors">
          ...
          <button
            ...
            className="flex min-h-[44px] items-center justify-center gap-1 text-[12.5px] font-bold text-ink px-3 rounded-full border border-border bg-paper hover:bg-chalk transition-colors active:scale-[0.98]"
