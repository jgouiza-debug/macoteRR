        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex w-full flex-col items-center justify-center gap-[3px] text-[8.5px] uppercase tracking-wide transition-[transform,color] duration-150 active:scale-90 ${
