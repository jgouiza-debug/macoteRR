...
export const DICTIONARY = {
  fr: {
    ...
    "starting.body1": "Au premier semestre, tu n'as pas encore de cote R officielle. Elle sera calculée par le ministère après la transmission des notes de groupe de ta première session (vers fin janvier ou début juin).",
  ...
  en: {
    ...
    "starting.body1": "In your first semester, you don't have an official R-score yet. It will be computed by the Ministry after group grades are submitted (around late January or early June).",
