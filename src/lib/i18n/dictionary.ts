...
export const DICTIONARY = {
  fr: {
    ...
    "account.checkEmailBody": "On a envoyé un lien de connexion à {email}. Touche-le pour continuer — pas besoin de mot de passe.",
  ...
  en: {
    ...
    "account.checkEmailBody": "We sent a sign-in link to {email}. Tap it to continue — no password needed.",
